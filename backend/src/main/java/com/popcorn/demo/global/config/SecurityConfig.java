	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.csrf(csrf -> csrf.disable())
				...
				.authorizeHttpRequests(authz -> authz
						...
						.requestMatchers(HttpMethod.GET, "/api/orders/v1/{orderId}/pay").permitAll()
						.requestMatchers(HttpMethod.POST, "/api/orders/v1/{orderId}/payments").hasAnyRole("CUSTOMER", "OWNER", "MANAGER")
						.requestMatchers(HttpMethod.GET, "/api/orders/v1/{orderId}/payments").permitAll()
						.requestMatchers(HttpMethod.GET, "/api/pay/v1/payments/{paymentId}").permitAll()
						.requestMatchers(HttpMethod.PATCH, "/api/pay/v1/payments/{paymentId}/status").permitAll()
						.requestMatchers(HttpMethod.DELETE, "/api/pay/v1/payments/{paymentId}").permitAll()
						.requestMatchers(HttpMethod.POST, "/api/pay/v1/payments/toss/confirm").permitAll()
