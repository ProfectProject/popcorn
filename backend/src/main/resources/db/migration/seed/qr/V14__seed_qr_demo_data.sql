...
VALUES ('00000000-0000-0000-0000-000000001001', 'QR-TEST-001', 1, '00000000-0000-0000-0000-000000000001', NULL, 'RESERVATION'::order_type, 'RESERVED'::order_status, now() + interval '1 day', 10000, NULL, now(), now(), 0)
ON CONFLICT DO NOTHING;
