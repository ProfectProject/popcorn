package com.popcorn.store.domain.store.config;
...
@ComponentScan(basePackages = {
		"com.popcorn.store.domain.store.service",
		"com.popcorn.store.domain.store.repository",
		"com.popcorn.store.domain.store.controller"
})
