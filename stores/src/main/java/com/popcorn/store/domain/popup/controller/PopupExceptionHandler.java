...
public class PopupExceptionHandler extends BaseController {
	...
	private String getUserFriendlyMessage(PopupException ex) {
		if (ex.getResponseCode() == com.popcorn.store.domain.popup.dto.PopupResponseCode.POPUP_NOT_FOUND) {
			return "팝업 정보를 찾을 수 없습니다.";
		}
		if (ex.getResponseCode() == com.popcorn.store.domain.popup.dto.PopupResponseCode.INVALID_REQUEST) {
			return "요청을 확인해 주세요.";
		}
